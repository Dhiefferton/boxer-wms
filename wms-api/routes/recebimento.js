...
async function criarPalletRecebimento({ sku, quantidade, deposito, enderecoId, numerosSerie, zenerpHandlingUnitCode }) {
    ...
    try {
        ...
        // Se veio do ERP (bipagem de pallet), guarda o próprio código
        // do ERP no pallet - mesmo que a etiqueta impressa agora seja
        // o PDF oficial do ERP (não a nossa), isso mantém o registro
        // aqui rastreável e é a base da checagem de idempotência acima.
