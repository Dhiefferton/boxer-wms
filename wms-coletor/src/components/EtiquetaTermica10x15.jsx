...
@media print {
    ...
    /* Posicionamento absoluto em vez de flexbox: cada seção ocupa um
       retângulo de tamanho e posição fixos dentro da etiqueta. Isso
       elimina de vez o problema de flexbox/altura sendo fragmentado
       em várias páginas pelo motor de impressão do navegador -
       nenhuma seção pode "empurrar" outra ou criar quebra de página,
       porque nenhuma delas participa do fluxo normal do documento. */
    ...
    #print-root-termica .etq10x15-secao-codigo { top: 0; height: 4.5cm; }
    #print-root-termica .etq10x15-secao-produto { top: 4.5cm; height: 4cm; }
