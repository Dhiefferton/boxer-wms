        ...
        <div className="tela">
            ...
            {proximaAcao === 'alocar-estoque' && (
                <>
                    ...
                    <div className="card">
                        <p style={{ fontSize: 11, color: 'var(--text-muted)', marginBottom: 8 }}>Itens da ordem de separação</p>
                ...
                <>
                    <div className="card">
                        <p style={{ fontSize: 12, color: 'var(--text-muted)', marginBottom: 8 }}>
                            Quantidade de volumes (fardos) usados para embalar esta ordem de separação
                        </p>
                        <input
                            type="number"
                            min="1"
