...
// e precisa trocar antes de ver qualquer outra coisa do sistema.
...
export default function TrocarSenha({ obrigatorio = false, aoFechar }) {
    ...
    const conteudo = (
        <form onSubmit={aoEnviar} className="card" style={{ width: 340, display: 'flex', flexDirection: 'column', gap: 14 }}>
            <div>
                <h1 style={{ fontSize: 22, color: 'var(--boxer-navy)' }}>Trocar senha</h1>
                {obrigatorio && (
